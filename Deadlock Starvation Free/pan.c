...
/*** From source: lab4_deadlock_starvation_free.pml ***/
...
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "lab4_deadlock_starvation_free.pml", 1, 2 },
	{ "-", 3, 4 }
};
uchar reached1 [] = {
	  0,   0,   0,   0, };
...
short src_ln0 [] = {
	  0,  12,  14,  15,  13,  18,  19,  17, 
	 21,  23,  24,  22,  27,  28,  26,  11, 
	 31,  31,  32,  35,  35,  36,  36,  37, 
	 37,  38,  38,  39,  39,  34,  41,  41, 
	 42,  43,  44,  45,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "lab4_deadlock_starvation_free.pml", 1, 35 },
	{ "-", 36, 37 }
};
uchar reached0 [] = {
	  0,   1,   1,   0,   0,   1,   0,   0, 
...
{	/* int i; */
	...
	case 1:
		...
		break;
	case 0:
		printf("local vars proc %d (philo):\n", pid);
		break;
	}
}
void
