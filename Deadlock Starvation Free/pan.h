...
#define PanSource	"lab4_deadlock_starvation_free.pml"
...
#define nstates1	3	/* monitor */
#define minseq1	35
#define maxseq1	36
#define endstate1	2

#define nstates0	36	/* philo */
#define minseq0	0
#define maxseq0	34
#define endstate0	35
...
#define Pphilo	((P0 *)this)
typedef struct P0 { /* philo */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#endif
#define PROG_LAB	5 /* progress labels */
#define NQS	0
