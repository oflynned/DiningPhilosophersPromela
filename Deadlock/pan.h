...
#define PanSource	"lab4_deadlock.pml"
...
#define Air1	(sizeof(P1) - Offsetof(P1, philosophers) - 1*sizeof(uchar))
...
#define Air0	(sizeof(P0) - Offsetof(P0, my_id) - 1*sizeof(int))
