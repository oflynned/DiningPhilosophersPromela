...
short src_ln2 [] = {
	  0,  46,  47,  45,  53,  54,  55,  52, 
	 58,  59,  57,  61,  51,  64,   0,   0, 
	 65,  69,  70,  71,   0, };
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "lab4.pml", 1, 13 },
...
{	int j, h = now._nr_pr;
	...
	case 2:	/* Phil_restart */
		...
		/* locals: */
#ifdef VAR_RANGES
		logval("Phil_restart:id", ((P2 *)pptr(h))->id);
#endif
#ifdef HAS_CODE
		locinit2(h);
#endif
	...
	case 1:	/* Philosopher */
		...
		/* locals: */
#ifdef VAR_RANGES
		logval("Philosopher:id", ((P1 *)pptr(h))->id);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* :init: */
		...
		((P0 *)pptr(h))->_1_1_i = 0;
#ifdef VAR_RANGES
		logval(":init::i", ((P0 *)pptr(h))->_1_1_i);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		...
		logval("count_eating", now.count_eating);
#endif
}
...
{	/* int i; */
	...
	case 3:
		...
		break;
	case 2:
		printf("local vars proc %d (Phil_restart):\n", pid);
	printf("	byte   id:	%d\n", ((P2 *)pptr(pid))->id);
		break;
	case 1:
